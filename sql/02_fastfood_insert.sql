...
SELECT setval(
  'public.cliente_id_seq',
  (SELECT MAX(id) FROM public.cliente),
  true
);

SELECT setval(
  'public.ingrediente_id_seq',
  (SELECT MAX(id) FROM public.ingrediente),
  true
);

SELECT setval(
  'public.tipo_pagamento_id_seq',
  (SELECT MAX(id) FROM public.tipo_pagamento),
  true
);

SELECT setval(
  'public.tipo_produto_id_seq',
  (SELECT MAX(id) FROM public.tipo_produto),
  true
);

SELECT setval(
  'public.pagamento_id_seq',
  (SELECT MAX(id) FROM public.pagamento),
  true
);

SELECT setval(
  'public.pedido_id_seq',
  (SELECT MAX(id) FROM public.pedido),
  true
);

SELECT setval(
  'public.pedido_item_id_seq',
  (SELECT MAX(id) FROM public.pedido_item),
  true
);

SELECT setval(
  'public.pedido_item_customizacao_id_seq',
  (SELECT MAX(id) FROM public.pedido_item_customizacao),
  true
);

SELECT setval(
  'public.produto_id_seq',
  (SELECT MAX(id) FROM public.produto),
  true
);

SELECT setval(
  'public.produto_ingrediente_id_seq',
  (SELECT MAX(id) FROM public.produto_ingrediente),
  true
);